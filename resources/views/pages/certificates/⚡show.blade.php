...
<div>
    ...
    <div class="mb-6 flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
        ...
        <div class="flex gap-2">
            @if (in_array($certificate->type, ['certificate_of_residency', 'barangay_clearance', 'certificate_of_indigency']) && in_array($certificate->status, ['processing', 'ready_for_pickup', 'completed']))
