...
<head>
    ...
    <title>Registration Not Approved — BeCISS</title>
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .header { background: linear-gradient(135deg, #dc2626 0%, #b91c1c 100%); padding: 40px 40px 32px; text-align: center; }
        ...
        .reason-card { background: #fef2f2; border-radius: 14px; border: 1px solid #fecaca; padding: 16px 20px; font-size: 14px; color: #991b1b; line-height: 1.7; margin-bottom: 28px; }
    ...
    <div class="wrapper">
        <div class="card">
            <div class="header">
                ...
                <div class="header-title">Registration Not Approved</div>
                <div class="header-sub">Your registration was reviewed by barangay staff</div>
            </div>

            <div class="body">
                <p class="greeting">Hi, <strong>{{ $recipientName }}</strong>,</p>
                <p class="message">
                    Thank you for registering with <strong>BeCISS</strong>. After review, your registration
                ...
                <p class="message">
                    You are welcome to register again using this same email address once the issue above
                    has been resolved.
                </p>

                <div class="security">
                    <strong>Need help?</strong> If you believe this was a mistake or you need assistance
                    completing your registration, please visit your local barangay office.
                </div>
            </div>
