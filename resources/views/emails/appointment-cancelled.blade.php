...
<head>
    ...
    <title>Appointment Cancelled — BeCISS</title>
    <style>
    ...
    <div class="wrapper">
        <div class="card">
            <div class="header">
                ...
                <div class="header-sub">Your appointment has been cancelled</div>
            </div>

            <div class="body">
                <p class="greeting">Hi, <strong>{{ $user->name }}</strong>!</p>
                <p class="message">
                    We're writing to inform you that your appointment at the barangay has been cancelled.
                </p>
                ...
                <div class="security">
                    <strong>Need to rebook?</strong> You may schedule a new appointment through BeCISS
