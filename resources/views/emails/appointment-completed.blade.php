...
<head>
    ...
    <title>Appointment Completed — BeCISS</title>
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .header { background: linear-gradient(135deg, #059669 0%, #10b981 100%); padding: 40px 40px 32px; text-align: center; }
        ...
        .notes-card { background: #f0fdf4; border-radius: 12px; padding: 16px 20px; font-size: 14px; color: #166534; line-height: 1.6; border: 1px solid #bbf7d0; margin-bottom: 28px; }
    ...
    <div class="wrapper">
        <div class="card">
            <div class="header">
                ...
                <div class="header-title">Appointment Completed</div>
                <div class="header-sub">Your appointment has been completed</div>
            </div>

            <div class="body">
                <p class="greeting">Hi, <strong>{{ $user->name }}</strong>!</p>
                <p class="message">
                    Your appointment at the barangay has been successfully completed. Thank you for your visit.
                </p>
                ...
                <div class="details-card">
                    ...
                    <div class="detail-row">
                        ...
                        <span class="detail-value">{{ $appointment->completed_at->format('F j, Y g:i A') }}</span>
                    </div>
                    <div class="detail-row">
                ...
                <div class="security">
                    <strong>Need further assistance?</strong> You can schedule another appointment through BeCISS
                    or visit the barangay office directly.
                </div>
            </div>
