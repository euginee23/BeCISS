...
<head>
    ...
    <title>Registration Approved — BeCISS</title>
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .cta-button { display: inline-block; padding: 14px 32px; background: linear-gradient(135deg, #16a34a 0%, #15803d 100%); color: #ffffff; font-size: 15px; font-weight: 700; border-radius: 12px; text-decoration: none; letter-spacing: 0.2px; }
        ...
        .footer-brand { font-size: 13px; font-weight: 700; color: #16a34a; margin-bottom: 6px; }
    ...
    <div class="wrapper">
        <div class="card">
            <div class="header">
                ...
                <div class="header-title">Registration Approved!</div>
                <div class="header-sub">Your account has been approved by barangay staff</div>
            </div>

            <div class="body">
                <p class="greeting">Hi, <strong>{{ $user->name }}</strong>!</p>
                <p class="message">
                    Great news — your registration with <strong>BeCISS</strong> has been reviewed and approved
                    by our barangay staff. You now have full access to the system.
                </p>
                ...
                <div class="details-card">
                    <div class="detail-row">
                        ...
                        <span class="detail-value">{{ $resident->full_name }}</span>
                    </div>
                    <div class="detail-row">
                    ...
                    <div class="detail-row">
                        ...
                        <span class="detail-value">{{ $resident->approved_at->format('F j, Y \a\t g:i A') }}</span>
                    </div>
                    <div class="detail-row">
                ...
                <div class="security">
                    <strong>Need help?</strong> If you have any questions about your account or the services
                    available, please visit your local barangay office or contact us through the system.
                </div>
            </div>
