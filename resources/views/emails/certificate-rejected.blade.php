...
<head>
    ...
    <title>Certificate Request Update — BeCISS</title>
    <style>
    ...
    <div class="wrapper">
        <div class="card">
            <div class="header">
                ...
                <div class="header-title">Certificate Request Rejected</div>
                <div class="header-sub">Your certificate request could not be processed</div>
            </div>

            <div class="body">
                <p class="greeting">Hi, <strong>{{ $user->name }}</strong>!</p>
                <p class="message">
                    We regret to inform you that your certificate request has been rejected.
                ...
                @if ($certificate->rejection_reason)
                    <div class="section-label">Reason for Rejection</div>
                ...
                <div class="security">
                    <strong>What can you do?</strong> You may submit a new certificate request after addressing
                    the issues above, or visit the barangay office for further assistance.
                </div>
            </div>
