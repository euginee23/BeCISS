...
<head>
    ...
    <title>Reset Your Password — BeCISS</title>
    <style>
    ...
    <div class="wrapper">
        <div class="card">
            ...
            <div class="body">
                ...
                <p class="message">
                    You requested a password reset for your <strong>BeCISS</strong> account.
                    Please enter the 6-digit code below to verify your identity and reset your password.
                </p>
                ...
                <div class="security">
                    <strong>Didn't request a password reset?</strong> If you didn't request this,
